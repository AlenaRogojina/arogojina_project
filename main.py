...
class Colors_app(tk.Tk):
    def __init__(self):
        ...
        self.posterbtn.grid(row=3, column=0, columnspan=2, padx=10, pady=10, sticky='we')

        self.presbtn = tk.Button(self, text="Download Presentation Template (.pptx)", command=self.pres) #use presentation (pres) function
        self.presbtn.grid(row=3, column=2, columnspan=2, padx=10, pady=10, sticky='we')
    ...
    def complementary(self):
        ...
        self.palette_rgb1 = (255 - r, 255 - g, 255 - b) #get new values and set as palette color 1

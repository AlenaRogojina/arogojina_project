...
#clear radio buttons--done
#dropdown to change size of templates?--maybe tomorrow
#can't show template with colors but can show generic template
#make save as new file instead of overwriting
...
class Colors_app(tk.Tk):
    ...
    def rgb_to_hsv(self, r,g,b): #cpnverting RGB values to HSV
        return colorsys.rgb_to_hsv(r/255.0, g/255.0, b/255.0)
    
    def hsv_to_rgb(self, h, s, v): #cpnverting HSV values back to RGB
    ...
    def colorpicker(self):
        ...
        self.canvas.delete("") #deletes what's diplayed on canvas currently
        self.img_data = None  # Add this line to stop color tracking
    ...
    def complementary(self):
        ...
        self.values2.config(text = "RGB: " + str(self.palette_rgb1))
        self.values3.config(text = "")
    ...
    def analogous(self):
        ...
        if newg1 > 255:
            newg1 = g - 15 #make sure new values aren't higher than 255
        newb1 = b
        ...
        self.palette_rgb1 = (newr1, newg1, newb1)
        self.palette_rgb2 = (newr2, newg2, newb2)
        '''
